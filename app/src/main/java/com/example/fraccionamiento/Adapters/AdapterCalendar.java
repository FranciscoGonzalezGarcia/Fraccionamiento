...
public class AdapterCalendar extends RecyclerView.Adapter<AdapterCalendar.ViewHolderData> implements View.OnClickListener {
    private View.OnClickListener listener;
    private ArrayList<CalendarClass> calendarList;

    public AdapterCalendar(ArrayList<CalendarClass> calendarList) {
